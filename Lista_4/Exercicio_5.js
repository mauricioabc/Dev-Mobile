    ...
    <View style={styles.container}>
      <View style={styles.container1}>
        ...
        <View style={styles.viewbotao}>
          <View style={styles.botaoTamanho}>
            <Button title='Confirmar' color='#32CD32' onPress={() => adicionaUsuario()}> </Button>
          </View>
          <View style={styles.botaoTamanho}>
            <Button title='Remover' color='#FF0000' onPress={() => removerUltimoUsuario()}> </Button>
          </View>
          <View style={styles.botaoTamanho}>
            <Button title='Limpar' color='#ADD8E6' onPress={() => limparCampos()}> </Button>
          </View>
        </View>
      </View>
